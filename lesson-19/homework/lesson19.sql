...
------------------------------------------------------------
-- Task 1: Procedure - Employee Bonus
------------------------------------------------------------
...
------------------------------------------------------------
-- Task 2: Procedure - Increase Department Salary
------------------------------------------------------------
CREATE OR ALTER PROCEDURE sp_IncreaseDepartmentSalary
    @Dept NVARCHAR(50),
...
END;
EXEC sp_IncreaseDepartmentSalary 'Sales', 5;
